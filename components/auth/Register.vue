<template>
  <div class="flex items-center justify-center bg-background">
    <div class="max-w-full w-full space-y-6 p-10 bg-white rounded-lg shadow-lg">
      <div>
        <h2 class="text-2xl px-16 font-bold text-primary">Créer un compte</h2>
      </div>
      ...
      <form class="space-y-6" @submit.prevent="handleRegister">
        <div>
          <label for="username" class="block text-sm font-medium text-primary mb-1">Nom d'utilisateur</label>
          <input
            id="username"
            v-model="username"
            type="text"
